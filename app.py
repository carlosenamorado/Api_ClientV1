...
from database import crear_tabla, guardar_usuarios, consultar_usuarios, eliminar_usuarios
...
if menu == "Inicio":   
    st.header("Bienvenido a la aplicacion API-SQLITE-STREAMLITE")
    st.write("Esta aplicacion permite obtener datos de una API y almacenarlos en una base de datos")
